...
import java.io.*;
import java.net.*;
public class Collatz_Compute_05
{
	public static void main(String args[]) throws IOException, InterruptedException
	{
		...
		String Compute_Node_Id="Collatz_Compute_05"; //Change
		try
		{
		...
		while(true)
		{
			if(Initial==1)
			{
				To_Server="905933900000000"; //Change
				Initial=0;
			}
			else
			{
				From_Compute=Compute_Engine_05.Engine_05(To_Compute); //Change
